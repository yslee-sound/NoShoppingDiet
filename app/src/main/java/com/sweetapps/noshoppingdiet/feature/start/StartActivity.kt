package com.sweetapps.noshoppingdiet.feature.start
...
import com.sweetapps.noshoppingdiet.feature.run.RunActivity
...
import com.sweetapps.noshoppingdiet.core.ui.components.AppUpdateDialog
import androidx.core.graphics.drawable.toDrawable
import com.sweetapps.noshoppingdiet.feature.addrecord.components.TargetDaysBottomSheet
...
fun StartScreenWithUpdate(
    ...
    val restartPromptText = stringResource(AppR.string.update_downloaded_restart_prompt)
    val actionRestartText = stringResource(AppR.string.action_restart)
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        AnimatedVisibility(
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = AppR.drawable.splash_app_icon),
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            ...
                            color = colorResource(id = AppR.color.color_title_primary),
                        ...
                        Row(
                            ...
                            Card(
                                ...
                                colors = CardDefaults.cardColors(containerColor = colorResource(id = AppR.color.color_bg_card_light)),
                                ...
                                Box(
                                    ...
                                    Text(
                                        ...
                                        color = colorResource(id = AppR.color.color_indicator_days),
...
fun ModernStartButton(isEnabled: Boolean, onStart: () -> Unit, modifier: Modifier = Modifier) {
    Card(
        ...
        colors = CardDefaults.cardColors(
            containerColor = if (isEnabled) colorResource(id = AppR.color.color_progress_primary) else colorResource(id = AppR.color.color_button_disabled)
        ),
