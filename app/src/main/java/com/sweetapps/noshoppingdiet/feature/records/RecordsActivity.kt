package com.sweetapps.noshoppingdiet.feature.records
...
import com.sweetapps.noshoppingdiet.feature.records.components.RecordsScreen
...
class RecordsActivity : BaseActivity() {
    ...
    override fun getScreenTitle(): String = "노쇼핑 기록"
