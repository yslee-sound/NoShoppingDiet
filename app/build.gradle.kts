...
android {
    namespace = "com.sweetapps.noshoppingdiet" // 코드 패키지 구조는 유지 (선택)
    compileSdk = 36

    // 버전 코드 전략: yyyymmdd + 2자리 시퀀스 (NN)
    // 이전 사용: 2025100800 -> 신규: 2025100801
    val releaseVersionCode = 2025102701
    val releaseVersionName = "1.0.1"

    defaultConfig {
        applicationId = "com.sweetapps.noshoppingdiet" // 변경: Play Console에서 com.example.* 금지 대응
        minSdk = 21
        targetSdk = 36
